...
export function ModCard({ mod, disabled, onToggle, onDetails }: ModCardProps) {
  ...
  return (
    <motion.article
      className="mod-card grid gap-3 rounded-[14px] border border-slate-300 bg-white p-[18px] transition duration-150 ease-in hover:-translate-y-px hover:border-accent hover:shadow-md dark:border-slate-700 dark:bg-slate-900 dark:hover:border-accent dark:hover:bg-slate-800/80 dark:hover:shadow-accent/20"
