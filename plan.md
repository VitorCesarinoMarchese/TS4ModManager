...
- UI review flow started: Mod Details can find source candidates, show loading/empty/error/missing-key states, show confidence/evidence, attach/open/ignore candidates, and warn on low confidence.
